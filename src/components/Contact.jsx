...
const Contact = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    formData.append("access_key", "989b0993-fbb0-49b2-8dfb-0b0b990d760d");
      ...
      >
        ...
        >
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-3'>Your Lovely Name</span>
            <input
              type='text'
              name='name'
              value={form.name}
          ...
          <label className='flex flex-col'>
            <span className='text-white font-medium mb-2'>Your Kind Message</span>
            <textarea
              rows={7}
              name='message'
              value={form.message}
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:srik3713@gmail.com" target="_blank" className="blue-text-gradient">srik3713@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
            <a href="https://api.whatsapp.com/send/?phone=917094295944&text&app_absent=0&lang=en" target="_blank" className="blue-text-gradient">
              +91 7094295944
            </a>
          </article>
        </div>
