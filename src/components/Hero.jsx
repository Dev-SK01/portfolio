...
const Hero = () => {
  ...
  useEffect(()=>
  {
    init(textRef.current, { showCursor: true, strings: [' FullStack Developer', "Tech Entrepreneur ", " Mentor ", " Investor",'Software Developer ', " Tech Enthusiast "] })
  },[]);
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Srikanth N</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/dev-sk01" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
          href="https://www.linkedin.com/in/srikanth-n-860207216" target="_blank">
          <ImLinkedin />
        </a>
        <a
          href="https://www.instagram.com/dev_sk_gamer" target="_blank">
          <AiOutlineInstagram />
        </a>
        <a
          href="https://linktr.ee/webma_startup" target="_blank">
          <BiLinkAlt />
        </a>
